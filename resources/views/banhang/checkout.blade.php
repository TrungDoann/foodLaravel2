				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="your-order">
										...
										<div class="media">
											...
											<div class="media-body">
												<p class="font-large">{{$product['item']['name']}}</p>
                                                 <span class="color-gray your-order-info">Số lượng:{{$product['item']['qty']}}</span>
                                                 <span class="color-gray your-order-info">Đơn giá:{{$product['price']/$product['qty']}}</span>
							...
							<div class="text-center"><button type="submit" class="beta-btn primary">Đặt hàng <i class="fa fa-chevron-right"></i></buton></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
